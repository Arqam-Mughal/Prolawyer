 ...
 */
class CaseModelCauseCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-cause-list');
        CRUD::setEntityNameStrings('cause list', 'cause lists');
