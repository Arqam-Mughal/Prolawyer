 ...
 */
class CaseModelDateAwaitedCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-date-awaited');
        CRUD::setEntityNameStrings('date awaited case', 'date awaited cases');
        ...
        $this->crud->addClause('whereNotNull', 'next_date');
        $this->crud->addClause('whereDate', 'next_date', '<', \Carbon\Carbon::now()->format('Y-m-d'));
    ...
    {
        if (!backpack_user()->hasRole('Super admin') && !backpack_user()->can('Date Awaited Cases'))
