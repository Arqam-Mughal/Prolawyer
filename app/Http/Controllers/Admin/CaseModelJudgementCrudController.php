 ...
 */
class CaseModelJudgementCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-judgement-case');
        CRUD::setEntityNameStrings('judgement case', 'judgement cases');
        ...
        $this->crud->addClause('where', 'judgement_status', '=', 'Judgement');
