 ...
 */
class CaseModelCaseCategoryCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-case-category');
        CRUD::setEntityNameStrings('case category', 'case categories');
        ...
        $this->crud->addClause('whereDate', 'next_date', Carbon::tomorrow()->format('Y-m-d'));
