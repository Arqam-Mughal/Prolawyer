 ...
 */
class CaseModelRunningCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-running-cases');
        CRUD::setEntityNameStrings('running case', 'running cases');
        ...
        $this->crud->addClause('orWhereIn', 'judgement_status', ['Open', 'Reopen']);
