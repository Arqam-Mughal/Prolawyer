 ...
 */
class CaseModelTomorrowCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-tomorrow');
        CRUD::setEntityNameStrings('tomorrow case', "tomorrow's cases");
        CRUD::enableExportButtons(['stack'=>'top']);
        ...
        $this->crud->addClause('whereDate', 'next_date', \Carbon\Carbon::tomorrow()->format('Y-m-d'));
    ...
    {
        if (!backpack_user()->hasRole('Super admin') && !backpack_user()->can('Tomorrow Cases'))
