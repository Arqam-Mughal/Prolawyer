 ...
 */
class CaseModelTodayCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-today');
        CRUD::setEntityNameStrings('today case', "today's cases");
    ...
    {
        if (!backpack_user()->hasRole('Super admin') && !backpack_user()->can('Today Cases'))
