 ...
 */
class CaseModelActiveCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/case-model-active');
        CRUD::setEntityNameStrings('active case', 'active cases');
    ...
    {
        if (!backpack_user()->hasRole('Super admin') && !backpack_user()->can('Active Cases'))
        $this->crud->denyAccess('list');

        // Remove the default create button
        $this->crud->removeButton('create');
        CRUD::enableExportButtons('top');
