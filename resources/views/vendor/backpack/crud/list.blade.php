    ...
    <div class="{{ $crud->getListContentClass() }}">
        ...
        @if ($crud->filtersEnabled())
          ...
          @if (str_contains( $current_route, 'case-model-' ))
            @include('crud::inc.filters_tabs_navbar')
          @elseif ( str_contains( $current_route, 'archive' ) )
            @include('crud::inc.filters_archive_navbar')
          @endif
...
@section('after_scripts')
  ...
  @include('crud::inc.inline_preview_modal')
  @include('crud::inc.inline_sync_modal')
