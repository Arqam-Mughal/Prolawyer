    ...
    $filter->options['date_range_options'] = array_replace_recursive(
        [
            ...
            'ranges' => [
                ...
                trans('backpack::crud.yesterday') => [
                    \Carbon\Carbon::now()->subDay()->startOfDay()->toDateTimeString(),
                    \Carbon\Carbon::now()->subDay()->endOfDay()->toDateTimeString(),
                ],
                trans('backpack::crud.last_7_days') => [
                    \Carbon\Carbon::now()->subDays(6)->startOfDay()->toDateTimeString(),
                    \Carbon\Carbon::now()->toDateTimeString(),
                ],
                trans('backpack::crud.last_30_days') => [
                    \Carbon\Carbon::now()->subDays(29)->startOfDay()->toDateTimeString(),
                    \Carbon\Carbon::now()->toDateTimeString(),
                ],
                trans('backpack::crud.this_month') => [
                    \Carbon\Carbon::now()->startOfMonth()->toDateTimeString(),
                    \Carbon\Carbon::now()->endOfMonth()->toDateTimeString(),
                ],
                trans('backpack::crud.last_month') => [
                    \Carbon\Carbon::now()->subMonth()->startOfMonth()->toDateTimeString(),
                    \Carbon\Carbon::now()->subMonth()->endOfMonth()->toDateTimeString(),
                ],
            ],
            'locale' => [
                'firstDay' => 0,
    ...
    <div class="dropdown-menu p-0">
        <div class="form-group backpack-filter mb-0">
            <div class="input-group date">
                ...
                <input class="form-control pull-right" id="daterangepicker-{{ $filter->key }}" type="text"
...
@push('crud_list_styles')
    <!-- include select2 css-->
    @basset('https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.min.css')
    <style>
        .input-group.date {
            width: 320px;
            max-width: 100%;
...
@push('crud_list_scripts')
    ...
    @basset('https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.min.js')
    <script>
